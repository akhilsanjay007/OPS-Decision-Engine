...
def build_pipeline() -> Pipeline:
    """
    Build Stage 3 pipeline using mixed feature types.
    ...
    Then combine all features and train Logistic Regression.
    """
...
def evaluate_model(model: Pipeline, X_test, y_test, output_dir: Path) -> None:
    """
    Evaluate the model and save outputs for analysis.
    """
...
def main():
    """
    Main Stage 3 training flow.
    """
    data_path = "data/processed/ml_priority_dataset_stage3.csv"
    model_path = "artifacts/ml/priority_stage3_pipeline.joblib"
    output_dir = Path("outputs/ml/stage3")
